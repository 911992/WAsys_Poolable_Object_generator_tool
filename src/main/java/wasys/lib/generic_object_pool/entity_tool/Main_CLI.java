...
File: Main_CLI.java
Created on: Jun 25, 2020 10:15:49 PM
...
public class Main_CLI {
    ...
    private static void show_help(){
        ...
        out.printf("%s <<pool_policy_stmt>>\t\t:Tells the statement/syntax for setting the pool policy variable(could be skipped)\n",CMD_POLICY_STATEMENT);
    ...
    public static void main(String args[]) {
        ...
        try(OutputStream _fous = get_result_out()){
            ...
            Type_Generator.generate_type(_package, _type, _pol_statement, _fous);
        }catch(Exception wt){
            wt.printStackTrace(System.err);
        }
...
//        //main(new String[]{CMD_PACKAGE_NAME,"package",CMD_TYPE_NAME,"My_Class",CMD_FILE_OUT,"D://aaa//My_Class.java"});
//        main(new String[]{CMD_PACKAGE_NAME,"package",CMD_TYPE_NAME,"My_Class",CMD_CLASS_NAME_FILE_OUT});
//    }
}
